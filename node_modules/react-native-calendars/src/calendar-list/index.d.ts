...
declare class CalendarList extends Component<Props, State> {
    ...
    static propTypes: {
        ...
        theme: PropTypes.Requireable<object>; /** Style for the List item (the calendar) */
        ...
        hideExtraDays: PropTypes.Requireable<boolean>; /** Called once when the scroll position gets within onEndReachedThreshold */
        ...
        webAriaLevel: PropTypes.Requireable<number>; /** Enable or disable vertical / horizontal scroll indicator. Default = false */
    };
    static defaultProps: {
        calendarWidth: number;
        calendarHeight: number;
